#!/usr/bin/env python3
from utils_model import get_result_path, create_dir_if_not_exists, \
...
BASELINE_MODELS = ['simgnn','beam1', 'beam2', 'beam5', 'beam10', 'beam20', 'beam40','beam80',
                   'hungarian', 'vj']
TRUE_MODEL = 'astar'
...
args2 = {'astar': {'marker': '*', 'facecolors': 'none', 'edgecolors': 'grey'},
         ...
         'vj': {'marker': 'h', 'facecolors': 'none',
                'edgecolors': 'darkcyan'},
         'simgnn': {'marker': 'h', 'facecolors': 'none',
                       'edgecolors': 'darkgrey'},
         'regression': {'marker': 'P',
...
def exp3():
    ...
    from utils_model import load_as_dict
    d = load_as_dict(
        '/home/ln/Downloads/SimGNN-1-master/model/Siamese/logs/siamese_regression_aids700nef_2019-08-11T06:46:01/test_info.pickle')
...
def exp9():
    data = load_as_dict("/home/ln/HAP-master/model/"
                        "Siamese/logs/"
                        "siamese_regression_aids700nef_2019-05-23T06:42:11/"
                        "test_info.pickle")
    embs = data['embs']
    dataset = 'aids700nef'
    model = 'astar'
