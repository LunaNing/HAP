...
from utils_model import get_ts, create_dir_if_not_exists, \
     save_as_dict, get_siamese_dir, get_model_info_as_str, need_val
...
class Saver(object):
    ...
    def save_test_info(self, sim_mat, time_li, best_iter, test_results):
        ...
        save_as_dict(sfn, sim_mat, time_li, best_iter, test_results)
